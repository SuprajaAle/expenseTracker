...
<div class="container mt-5">
    <form:form action="saved" modelAttribute="user" method="post">
    <div class="form-group">
        <label for="exampleInputEmail1">Email address (*)</label> <form:errors path="username" cssClass="ml-5 text-danger"/>
        <form:input type="text" cssClass="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" path="username" />
    ...
    <button type="submit" class="btn btn-primary w-25" aria-describedby="new" >LogIn</button>
